...
dpkg-deb -b kali-incogsurf-deb-src/ kali-incogsurf.deb # Build the deb package
dpkg -i kali-incogsurf.deb || (apt-get -f install && dpkg -i kali-incogsurf.deb) # this will automatically install the required packages
